...
const ModelClassMock: TJestMock & Partial<{
    find: TJestMock, findOne: TJestMock,
    findOneAndUpdate: TJestMock<Error> & Partial<{ _succeededCall: () => typeof Model, _clazz: typeof Model, _failedCall: () => null }>,
    distinct: TJestMock
}> = jest.fn(() => {
    // @ts-ignore
    return new Model();
...
const ModelModuleMock: TJestMock & Partial<{
    _ModelClassMock: typeof ModelClassMock, _ModelPrototypeSaveMock: typeof Model.prototype.save
